"the quick brown fox" "fox" Write a function that takes both strings, and returns me the index (or pointer) of the first
instance of the substring("fox") within the main string
